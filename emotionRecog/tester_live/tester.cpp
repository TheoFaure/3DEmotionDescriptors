...
//TEST WITH MODEL
	...
	{
		std::string cmd_str = "python /home/theo/Documents/3D/Projet/emotionRecog/python_classifier/tester_rf.py \"" + histogram_str + "\"";
	...
	{
		std::string cmd_str = "python /home/theo/Documents/3D/Projet/emotionRecog/python_classifier/tester_svm.py \"" + histogram_str + "\"";
		const char * cmd = cmd_str.c_str();
		std::string res = exec(cmd);
		std::istringstream buffer(res);
		int value;
